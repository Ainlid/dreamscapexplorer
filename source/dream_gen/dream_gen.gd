...
func _randomize_mats():
	for n in globals.tilemats.size():
		...
		current_mat.albedo_color.h = globals.dream_rng.randf()
		current_mat.albedo_color.s = globals.dream_rng.randf()
		current_mat.albedo_color.v = globals.dream_rng.randf_range(0.2, 1.0)
